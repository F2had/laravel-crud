        ...
        <div>
            ...
            <form action="/student/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ $student->age }}" name="age" class="form-control" id="name">
                    @error('age')
                        <div class="error text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="department" value="{{ $student->department }}" name="department" class="form-control"
                        id="department" aria-describedby="department">
                    @error('department')
                        <div class="error text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" value="{{ $student->state }}" name="state" class="form-control" id="state">
                    @error('state')
                        <div class="error text-danger">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="nationality" class="form-select form-control" id="nationality">
                        <option value="{{ $student->nationality }}" selected>{{ $student->nationality }}</option>
                        <option value="Afghanistan">Afghanistan</option>
                        <option value="Åland Islands">Åland Islands</option>
                        <option value="Albania">Albania</option>
                        <option value="Algeria">Algeria</option>
